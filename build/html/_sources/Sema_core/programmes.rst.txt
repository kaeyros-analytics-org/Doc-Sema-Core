...
.. figure:: ../_images/sema_screenshot_placeholder.svg
   :alt: Capture à insérer des programmes de fidélité ou tombola
   :width: 90%
...
.. figure:: ../_images/sema_screenshot_placeholder.svg
   :alt: Capture à insérer de la liste des programmes
   :width: 90%
...
**1.** Cliquez sur **Créer** ou **Ajouter**.
**2.** Donnez un nom au programme.
**3.** Définissez la période.
**4.** Décrivez les règles de participation.
**5.** Configurez les récompenses ou lots.
**6.** Enregistrez.
...
.. figure:: ../_images/sema_screenshot_placeholder.svg
   :alt: Capture à insérer de la création d'un programme
   :width: 90%
...
**1.** Ouvrez la campagne ou le scénario concerné.
**2.** Ajoutez le message d'annonce.
**3.** Ajoutez le lien, bouton ou action de participation.
**4.** Utilisez une variable pour suivre la participation si nécessaire.
...
.. figure:: ../_images/sema_screenshot_placeholder.svg
   :alt: Capture à insérer d'un programme lié à une campagne
   :width: 90%
...
**1.** Ouvrez le détail du programme.
**2.** Consultez le nombre de participants.
**3.** Vérifiez les statuts.
**4.** Exportez la liste si l'option est disponible.
**5.** Analysez les résultats dans le tableau de bord si les données sont remontées.

Bonnes pratiques
----------------

**1.** Rédigez des règles simples.
**2.** Précisez la période du programme.
**3.** Testez l'inscription avant lancement.
**4.** Vérifiez les obligations légales ou internes liées aux concours.
**5.** Suivez les résultats dès le démarrage.
