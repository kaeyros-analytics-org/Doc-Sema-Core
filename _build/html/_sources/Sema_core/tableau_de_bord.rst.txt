...
.. figure:: ../_images/filters.png
   :alt: Capture à insérer des filtres du tableau de bord Sema Core
   :width: 90%
...
.. 5 — Exporter ou partager les résultats
.. --------------------------------------------

.. Si l'export est activé :

.. **1.** Appliquez les filtres souhaités.

.. **2.** Cliquez sur **Exporter**, **Télécharger** ou l'action équivalente.

.. **3.** Sélectionnez le format disponible, par exemple CSV ou Excel.

.. **4.** Vérifiez le fichier téléchargé.

.. **5.** Partagez uniquement les données nécessaires.

.. Capture à insérer — Export du tableau de bord
.. ---------------------------------------------

.. .. figure:: ../_images/sema_screenshot_placeholder.svg
..   :alt: Capture à insérer de l'export dashboard
..  :width: 90%

.. Ajoutez ici une capture du bouton ou menu d'export.
